...
//typedef enum {
var CMD_FL_ALL				= -1;
var CMD_FL_CHEAT			= BIT(0);	// command is considered a cheat
var CMD_FL_SYSTEM			= BIT(1);	// system command
var CMD_FL_RENDERER			= BIT(2);	// renderer command
var CMD_FL_SOUND			= BIT(3);	// sound command
var CMD_FL_GAME				= BIT(4);	// game command
var CMD_FL_TOOL				= BIT(5);	// tool command
//} cmdFlags_t;
