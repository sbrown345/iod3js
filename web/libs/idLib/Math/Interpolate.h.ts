...
////	speed = ( this.endValue - startValue ) * ( 1000.0 / ( (float) this.linearTime + ( this.accelTime + this.decelTime ) * 0.5f ) );
////
////	if ( this.accelTime ) {
...
////			extrapolate.Init( startTime + accelTime + linearTime, decelTime, this.endValue - ( extrapolate.GetSpeed() * ( decelTime * 0.001f * 0.5f ) ), extrapolate.GetBaseSpeed(), extrapolate.GetSpeed(), EXTRAPOLATION_DECELLINEAR );
////		}
////	}
////}
////
...
////	}
////	this.linearTime = duration - this.accelTime - this.decelTime;
////	speed = ( this.endValue - startValue ) * ( 1000.0f / ( (float) this.linearTime + ( this.accelTime + this.decelTime ) * idMath::SQRT_1OVER2 ) );
////
////	if ( this.accelTime ) {
...
////			extrapolate.Init( startTime + accelTime + linearTime, decelTime, this.endValue - ( extrapolate.GetSpeed() * ( decelTime * 0.001f * idMath::SQRT_1OVER2 ) ), extrapolate.GetBaseSpeed(), extrapolate.GetSpeed(), EXTRAPOLATION_DECELSINE );
////		}
////	}
////}
////
