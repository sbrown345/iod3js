...
/// <reference path="doomdll/ui/window.h.ts" />
/// <reference path="doomdll/ui/simplewindow.h.ts" />
/// <reference path="doomdll/ui/window.cpp.ts" />
...
/// <reference path="dlls/game/physics/force.cpp.ts" />
/// <reference path="dlls/game/physics/force_constant.cpp.ts" />
/// <reference path="dlls/game/physics/force_drag.cpp.ts" />
/// <reference path="dlls/game/physics/force_field.cpp.ts" />
/// <reference path="dlls/game/physics/force_spring.cpp.ts" />
/// <reference path="dlls/game/physics/physics.cpp.ts" />
/// <reference path="dlls/game/physics/physics_base.cpp.ts" />
/// <reference path="dlls/game/physics/physics_af.h.ts" />
/// <reference path="dlls/game/physics/physics_af.cpp.ts" />
/// <reference path="dlls/game/physics/physics_actor.cpp.ts" />
/// <reference path="dlls/game/physics/physics_monster.cpp.ts" />
/// <reference path="dlls/game/physics/physics_parametric.cpp.ts" />
/// <reference path="dlls/game/physics/physics_player.cpp.ts" />
/// <reference path="dlls/game/physics/physics_rigidbody.cpp.ts" />
/// <reference path="dlls/game/physics/physics_static.cpp.ts" />
/// <reference path="dlls/game/physics/physics_staticmulti.cpp.ts" />
/// <reference path="dlls/game/physics/push.cpp.ts" />
