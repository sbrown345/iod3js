...
class idForce_Drag extends idForce {
...
//	CLASS_PROTOTYPE(idForce_Drag);
	...
	static eventCallbacks: idEventFunc<idForce_Drag>[];
//
//	idForce_Drag(void);
...
idForce_Drag.CreateInstance = function ( ): idClass {
	try {
		var ptr = new idForce_Drag;
...
idForce_Drag.prototype.GetType = function ( ): idTypeInfo {
	return ( idForce_Drag.Type );
};

idForce_Drag.eventCallbacks = [
];

idForce_Drag.Type = new idTypeInfo( "idForce_Drag", "idForce",
	idForce_Drag.eventCallbacks, idForce_Drag.CreateInstance, idForce_Drag.prototype.Spawn,
	idForce_Drag.prototype.Save, idForce_Drag.prototype.Restore );
