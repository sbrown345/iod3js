...
var PUSHFL_ONLYMOVEABLE			=1		// only push moveable entities
var PUSHFL_NOGROUNDENTITIES		=2		// don't push entities the clip model rests upon
var PUSHFL_CLIP					=4		// also clip against all non-moveable entities
var PUSHFL_CRUSH				=8		// kill blocking entities
var PUSHFL_APPLYIMPULSE			=16		// apply impulse to pushed entities
