...
class idForce_Field extends idForce {
	//
	//public:
	...
	static eventCallbacks: idEventFunc<idForce_Field>[];
	//
...
idForce_Field.CreateInstance = function() : idClass{
	try {
		var ptr = new idForce_Field;
...
idForce_Field.prototype.GetType = function ( ): idTypeInfo {
	return ( idForce_Field.Type );
};

idForce_Field.eventCallbacks = [
];

idForce_Field.Type = new idTypeInfo( "idForce_Field", "idForce",
	idForce_Field.eventCallbacks, idForce_Field.CreateInstance, idForce_Field.prototype.Spawn,
	idForce_Field.prototype.Save, idForce_Field.prototype.Restore );
