...
class idForce_Spring extends idForce {
	//
	//public:
	...
	static	eventCallbacks : idEventFunc<idForce_Spring>[];
	//
	//	idForce_Spring(void);
...
idForce_Spring.CreateInstance = function() : idClass{
	try {
		var ptr = new idForce_Spring;
...
idForce_Spring.prototype.GetType = function ( ): idTypeInfo {
	return ( idForce_Spring.Type );
};

idForce_Spring.eventCallbacks = [
];

idForce_Spring.Type = new idTypeInfo( "idForce_Spring", "idForce",
	idForce_Spring.eventCallbacks, idForce_Spring.CreateInstance, idForce_Spring.prototype.Spawn,
	idForce_Spring.prototype.Save, idForce_Spring.prototype.Restore );
