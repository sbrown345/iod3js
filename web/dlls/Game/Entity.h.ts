...
//private:
	...
	*/
	SetModel ( modelname: string ): void {
		...
		if ( !this.renderEntity.customSkin ) {
...
////	idMat3 axis;
////
////	if ( !g_bloodEffects.GetBool() || this.renderEntity.joints == NULL ) {
////		return;
////	}
////
////	const idDeclEntityDef *def = gameLocal.FindEntityDef( damageDefName, false );
...
////	dir.Normalize();
////
////	axis = this.renderEntity.joints[jointNum].ToMat3() * this.renderEntity.axis;
////	origin = this.renderEntity.origin + this.renderEntity.joints[jointNum].ToVec3() * this.renderEntity.axis;
////
...
////	this.animator.ClearJoint( jointnum );
////}
////
/////*
////================
...
////	this.animator.SetJointPos( jointnum, transform_type, pos );
////}
////
/////*
////================
