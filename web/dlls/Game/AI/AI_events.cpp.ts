...
var AI_FindEnemy = new idEventDef(  "findEnemy", "d", 'e' );
var AI_FindEnemyAI = new idEventDef(  "findEnemyAI", "d", 'e' );
var AI_FindEnemyInCombatNodes = new idEventDef(  "findEnemyInCombatNodes", null, 'e' );
var AI_ClosestReachableEnemyOfEntity = new idEventDef(  "closestReachableEnemyOfEntity", "E", 'e' );
var AI_HeardSound = new idEventDef(  "heardSound", "d", 'e' );
var AI_SetEnemy = new idEventDef(  "setEnemy", "E" );
var AI_ClearEnemy = new idEventDef(  "clearEnemy" );
var AI_MuzzleFlash = new idEventDef(  "muzzleFlash", "s" );
var AI_CreateMissile = new idEventDef(  "createMissile", "s", 'e' );
var AI_AttackMissile = new idEventDef(  "attackMissile", "s", 'e' );
var AI_FireMissileAtTarget = new idEventDef(  "fireMissileAtTarget", "ss", 'e' );
var AI_LaunchMissile = new idEventDef(  "launchMissile", "vv", 'e' );
var AI_AttackMelee = new idEventDef(  "attackMelee", "s", 'd' );
var AI_DirectDamage = new idEventDef(  "directDamage", "es" );
var AI_RadiusDamageFromJoint = new idEventDef(  "radiusDamageFromJoint", "ss" );
var AI_BeginAttack = new idEventDef(  "attackBegin", "s" );
var AI_EndAttack = new idEventDef(  "attackEnd" );
var AI_MeleeAttackToJoint = new idEventDef(  "meleeAttackToJoint", "ss", 'd' );
var AI_RandomPath = new idEventDef(  "randomPath", null, 'e' );
var AI_CanBecomeSolid = new idEventDef(  "canBecomeSolid", null, 'f' );
var AI_BecomeSolid = new idEventDef(  "becomeSolid" );
var AI_BecomeRagdoll = new idEventDef(  "becomeRagdoll", null, 'd' );
var AI_StopRagdoll = new idEventDef(  "stopRagdoll" );
var AI_SetHealth = new idEventDef(  "setHealth", "f" );
var AI_GetHealth = new idEventDef(  "getHealth", null, 'f' );
var AI_AllowDamage = new idEventDef(  "allowDamage" );
var AI_IgnoreDamage = new idEventDef(  "ignoreDamage" );
var AI_GetCurrentYaw = new idEventDef(  "getCurrentYaw", null, 'f' );
var AI_TurnTo = new idEventDef(  "turnTo", "f" );
var AI_TurnToPos = new idEventDef(  "turnToPos", "v" );
var AI_TurnToEntity = new idEventDef(  "turnToEntity", "E" );
var AI_MoveStatus = new idEventDef(  "moveStatus", null, 'd' );
var AI_StopMove = new idEventDef(  "stopMove" );
var AI_MoveToCover = new idEventDef(  "moveToCover" );
var AI_MoveToEnemy = new idEventDef(  "moveToEnemy" );
var AI_MoveToEnemyHeight = new idEventDef(  "moveToEnemyHeight" );
var AI_MoveOutOfRange = new idEventDef(  "moveOutOfRange", "ef" );
var AI_MoveToAttackPosition = new idEventDef(  "moveToAttackPosition", "es" );
var AI_Wander = new idEventDef(  "wander" );
var AI_MoveToEntity = new idEventDef(  "moveToEntity", "e" );
var AI_MoveToPosition = new idEventDef(  "moveToPosition", "v" );
var AI_SlideTo = new idEventDef(  "slideTo", "vf" );
var AI_FacingIdeal = new idEventDef(  "facingIdeal", null, 'd' );
var AI_FaceEnemy = new idEventDef(  "faceEnemy" );
var AI_FaceEntity = new idEventDef(  "faceEntity", "E" );
var AI_GetCombatNode = new idEventDef(  "getCombatNode", null, 'e' );
var AI_EnemyInCombatCone = new idEventDef(  "enemyInCombatCone", "Ed", 'd' );
var AI_WaitMove = new idEventDef(  "waitMove" );
var AI_GetJumpVelocity = new idEventDef(  "getJumpVelocity", "vff", 'v' );
var AI_EntityInAttackCone = new idEventDef(  "entityInAttackCone", "E", 'd' );
var AI_CanSeeEntity = new idEventDef(  "canSee", "E", 'd' );
var AI_SetTalkTarget = new idEventDef(  "setTalkTarget", "E" );
var AI_GetTalkTarget = new idEventDef(  "getTalkTarget", null, 'e' );
var AI_SetTalkState = new idEventDef(  "setTalkState", "d" );
var AI_EnemyRange = new idEventDef(  "enemyRange", null, 'f' );
var AI_EnemyRange2D = new idEventDef(  "enemyRange2D", null, 'f' );
var AI_GetEnemy = new idEventDef(  "getEnemy", null, 'e' );
var AI_GetEnemyPos = new idEventDef(  "getEnemyPos", null, 'v' );
var AI_GetEnemyEyePos = new idEventDef(  "getEnemyEyePos", null, 'v' );
var AI_PredictEnemyPos = new idEventDef(  "predictEnemyPos", "f", 'v' );
var AI_CanHitEnemy = new idEventDef(  "canHitEnemy", null, 'd' );
var AI_CanHitEnemyFromAnim = new idEventDef(  "canHitEnemyFromAnim", "s", 'd' );
var AI_CanHitEnemyFromJoint = new idEventDef(  "canHitEnemyFromJoint", "s", 'd' );
var AI_EnemyPositionValid = new idEventDef(  "enemyPositionValid", null, 'd' );
var AI_ChargeAttack = new idEventDef(  "chargeAttack", "s" );
var AI_TestChargeAttack = new idEventDef(  "testChargeAttack", null, 'f' );
var AI_TestMoveToPosition = new idEventDef(  "testMoveToPosition", "v", 'd' );
var AI_TestAnimMoveTowardEnemy = new idEventDef(  "testAnimMoveTowardEnemy", "s", 'd' );
var AI_TestAnimMove = new idEventDef(  "testAnimMove", "s", 'd' );
var AI_TestMeleeAttack = new idEventDef(  "testMeleeAttack", null, 'd' );
var AI_TestAnimAttack = new idEventDef(  "testAnimAttack", "s", 'd' );
var AI_Shrivel = new idEventDef(  "shrivel", "f" );
var AI_Burn = new idEventDef(  "burn" );
var AI_ClearBurn = new idEventDef(  "clearBurn" );
var AI_PreBurn = new idEventDef(  "preBurn" );
var AI_SetSmokeVisibility = new idEventDef(  "setSmokeVisibility", "dd" );
var AI_NumSmokeEmitters = new idEventDef(  "numSmokeEmitters", null, 'd' );
var AI_WaitAction = new idEventDef(  "waitAction", "s" );
var AI_StopThinking = new idEventDef(  "stopThinking" );
var AI_GetTurnDelta = new idEventDef(  "getTurnDelta", null, 'f' );
var AI_GetMoveType = new idEventDef(  "getMoveType", null, 'd' );
var AI_SetMoveType = new idEventDef(  "setMoveType", "d" );
var AI_SaveMove = new idEventDef(  "saveMove" );
var AI_RestoreMove = new idEventDef(  "restoreMove" );
var AI_AllowMovement = new idEventDef(  "allowMovement", "f" );
var AI_JumpFrame = new idEventDef(  "<jumpframe>" );
var AI_EnableClip = new idEventDef(  "enableClip" );
var AI_DisableClip = new idEventDef(  "disableClip" );
var AI_EnableGravity = new idEventDef(  "enableGravity" );
var AI_DisableGravity = new idEventDef(  "disableGravity" );
var AI_EnableAFPush = new idEventDef(  "enableAFPush" );
var AI_DisableAFPush = new idEventDef(  "disableAFPush" );
var AI_SetFlySpeed = new idEventDef(  "setFlySpeed", "f" );
var AI_SetFlyOffset = new idEventDef(  "setFlyOffset", "d" );
var AI_ClearFlyOffset = new idEventDef(  "clearFlyOffset" );
var AI_GetClosestHiddenTarget = new idEventDef(  "getClosestHiddenTarget", "s", 'e' );
var AI_GetRandomTarget = new idEventDef(  "getRandomTarget", "s", 'e' );
var AI_TravelDistanceToPoint = new idEventDef(  "travelDistanceToPoint", "v", 'f' );
var AI_TravelDistanceToEntity = new idEventDef(  "travelDistanceToEntity", "e", 'f' );
var AI_TravelDistanceBetweenPoints = new idEventDef(  "travelDistanceBetweenPoints", "vv", 'f' );
var AI_TravelDistanceBetweenEntities = new idEventDef(  "travelDistanceBetweenEntities", "ee", 'f' );
var AI_LookAtEntity = new idEventDef(  "lookAt", "Ef" );
var AI_LookAtEnemy = new idEventDef(  "lookAtEnemy", "f" );
var AI_SetJointMod = new idEventDef(  "setBoneMod", "d" );
var AI_ThrowMoveable = new idEventDef(  "throwMoveable" );
var AI_ThrowAF = new idEventDef(  "throwAF" );
var AI_RealKill = new idEventDef(  "<kill>" );
var AI_Kill = new idEventDef(  "kill" );
var AI_WakeOnFlashlight = new idEventDef(  "wakeOnFlashlight", "d" );
var AI_LocateEnemy = new idEventDef(  "locateEnemy" );
var AI_KickObstacles = new idEventDef(  "kickObstacles", "Ef" );
var AI_GetObstacle = new idEventDef(  "getObstacle", null, 'e' );
var AI_PushPointIntoAAS = new idEventDef(  "pushPointIntoAAS", "v", 'v' );
var AI_GetTurnRate = new idEventDef(  "getTurnRate", null, 'f' );
var AI_SetTurnRate = new idEventDef(  "setTurnRate", "f" );
var AI_AnimTurn = new idEventDef(  "animTurn", "f" );
var AI_AllowHiddenMovement = new idEventDef(  "allowHiddenMovement", "d" );
var AI_TriggerParticles = new idEventDef(  "triggerParticles", "s" );
var AI_FindActorsInBounds = new idEventDef(  "findActorsInBounds", "vv", 'e' );
var AI_CanReachPosition = new idEventDef(  "canReachPosition", "v", 'd' );
var AI_CanReachEntity = new idEventDef(  "canReachEntity", "E", 'd' );
var AI_CanReachEnemy = new idEventDef(  "canReachEnemy", null, 'd' );
...
////=====================
////*/
////void idAI::Event_MuzzleFlash( jointname:string ) {
////	idVec3	muzzle;
////	idMat3	axis;
////
...
////=====================
////*/
////void idAI::Event_CreateMissile( jointname:string ) {
////	idVec3 muzzle;
////	idMat3 axis;
////
////	if ( !projectileDef ) {
...
////=====================
////*/
////void idAI::Event_AttackMissile( jointname:string ) {
////	idProjectile *proj;
////
...
////=====================
////*/
////void idAI::Event_FireMissileAtTarget( jointname:string, const char *targetname ) {
////	idEntity		*aent;
////	idProjectile	*proj;
////
...
////=====================
////*/
////void idAI::Event_RadiusDamageFromJoint( jointname:string, const char *damageDefName ) {
////	jointHandle_t joint;
////	idVec3 org;
////	idMat3 axis;
////
...
////=====================
////*/
////void idAI::Event_MeleeAttackToJoint( jointname:string, const char *meleeDefName ) {
////	jointHandle_t	joint;
////	idVec3			start;
////	idVec3			end;
////	idMat3			axis;
...
////=====================
////*/
////void idAI::Event_TurnToPos( pos:idVec3 ) {
////	TurnToward( pos );
////}
////
/////*
...
////=====================
////*/
////void idAI::Event_MoveToPosition( pos:idVec3 ) {
////	StopMove( MOVE_STATUS_DONE );
////	MoveToPosition( pos );
////}
////
...
////		pos:idVec3 = enemyEnt->GetPhysics()->GetOrigin();
...
////=====================
////*/
////void idAI::Event_GetJumpVelocity( pos:idVec3, /*float*/ speed:number, float max_height ) {
////	idVec3 start;
////	idVec3 end;
////	idVec3 dir;
////	float dist;
...
////=====================
////*/
////void idAI::Event_CanHitEnemyFromJoint( jointname:string ) {
////	trace_t	tr;
////	idVec3	muzzle;
////	idMat3	axis;
////	idVec3	start;
...
////================
////*/
////void idAI::Event_PushPointIntoAAS( pos:idVec3 ) {
////	int		areaNum;
////	idVec3	newPos;
////
...
////================
////*/
////void idAI::Event_CanReachPosition( pos:idVec3 ) {
////	aasPath_t	path;
////	int			toAreaNum;
////	int			areaNum;
////
