...
//// command flags
//typedef enum {
var CMD_FL_ALL = -1, CMD_FL_CHEAT = BIT(0), CMD_FL_SYSTEM = BIT(1), CMD_FL_RENDERER = BIT(2), CMD_FL_SOUND = BIT(3), CMD_FL_GAME = BIT(4), CMD_FL_TOOL = BIT(5);
...
/*ID_INLINE void idCmdSystem::*/ function ArgCompletion_Boolean(/*const idCmdArgs &*/ args, callback) {
    todoThrow();
}
...
function ArgCompletion_String_Template(strings) {
    return function (args, callback) {
        todoThrow("ArgCompletion_String_Template return func todo");
        ArgCompletion_String(strings, args, callback);
    };

    function ArgCompletion_String(strings, /*const idCmdArgs &*/ args, callback) {
        todoThrow();
    }
}
...
//}
function ArgCompletion_ModelName(/*const idCmdArgs &*/ args, callback) {
    todoThrow();
}
...
//}
function ArgCompletion_ConfigName(/*const idCmdArgs &*/ args, callback) {
    todoThrow();
}
//@ sourceMappingURL=CmdSystem.h.js.map
