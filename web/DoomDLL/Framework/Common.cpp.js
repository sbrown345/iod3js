...
var idCommon = (function () {
    ...
    */
    ...
    ==================
    */
    idCommon.prototype.Printf = function (/*const char **/ fmt) {
        var args = [];
    ...
    ==================
    */
    idCommon.prototype.DPrintf = function (fmt) {
        var args = [];
        for (var _i = 0; _i < (arguments.length - 1); _i++) {
            args[_i] = arguments[_i + 1];
        }
    ...
    ==================
    */
    idCommon.prototype.Warning = function (/*const char **/ fmt) {
        var args = [];
        for (var _i = 0; _i < (arguments.length - 1); _i++) {
            args[_i] = arguments[_i + 1];
        }
    ...
    ==================
    */
    idCommon.prototype.Error = function (fmt) {
        var args = [];
        for (var _i = 0; _i < (arguments.length - 1); _i++) {
            args[_i] = arguments[_i + 1];
        }
    ...
    ==================
    */
    idCommon.prototype.FatalError = function (/*const char **/ fmt) {
        var args = [];
        for (var _i = 0; _i < (arguments.length - 1); _i++) {
            args[_i] = arguments[_i + 1];
        }
    ...
    =================
    */
    /*idCommonLocal::Init*/ idCommon.prototype.Init = function (/*int*/ argc, /*const char ***/ argv, /*const char **/ cmdline) {
        ////try {
    ...
    =================
    */
    /*idCommonLocal::*/ idCommon.prototype.InitGame = function () {
...
//@ sourceMappingURL=Common.cpp.js.map
