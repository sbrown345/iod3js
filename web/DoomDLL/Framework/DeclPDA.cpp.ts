...
////	src.SetFlags( LEXFL_NOSTRINGCONCAT | lexerFlags_t.LEXFL_ALLOWPATHNAMES |	LEXFL_ALLOWMULTICHARLITERALS | LEXFL_ALLOWBACKSLASHSTRINGCONCAT | lexerFlags_t.LEXFL_NOFATALERRORS );
////	src.SkipUntilString( "{" );
////
////	text = "";
////	// scan through, identifying each individual parameter
