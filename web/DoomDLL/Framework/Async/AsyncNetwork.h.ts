/// <reference path="../../sys/sys_public.h.ts" />
///*
//===========================================================================
//
...
var MAX_ASYNC_CLIENTS			= 32;

var MAX_USERCMD_BACKUP		= 256;
var MAX_USERCMD_DUPLICATION	= 25;
var MAX_USERCMD_RELAY			= 10;

 //index 0 is hardcoded to be the idnet master
 //which leaves 4 to user customization
var MAX_MASTER_SERVERS		= 5;

var MAX_NICKLEN				= 32;
//
// max number of servers that will be scanned for at a single IP address
var MAX_SERVER_PORTS			= 8;

// special game init ids
var GAME_INIT_ID_INVALID		= -1;
var GAME_INIT_ID_MAP_LOAD		= -2;
