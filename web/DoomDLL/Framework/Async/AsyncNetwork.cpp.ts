...
static Init( ):void {
	...
	idAsyncNetwork.masters = newStructArray<master_t>( master_t, MAX_MASTER_SERVERS );
	idAsyncNetwork.masters[0].$var = idAsyncNetwork.master0;
	idAsyncNetwork.masters[1].$var = idAsyncNetwork.master1;
	idAsyncNetwork.masters[2].$var = idAsyncNetwork.master2;
	idAsyncNetwork.masters[3].$var = idAsyncNetwork.master3;
	idAsyncNetwork.masters[4].$var = idAsyncNetwork.master4;
