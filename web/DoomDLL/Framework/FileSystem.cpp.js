...
var idFileSystemLocal = (function (_super) {
    ...
    */
    /*int*/
    idFileSystemLocal.prototype.ReadFile = function (relativePath, /*void ***/ buffer, /*ID_TIME_T **/ timestamp) {
        var f;
    ...
    */
    /*int*/
    idFileSystemLocal.prototype.GetFileList = function (relativePath, extensions, list, hashIndex, fullRelativePath, gamedir) {
        //searchpath_t *	search;
        //fileInPack_t *	buildBuffer;
    ...
    */
    ...
    ===========
    */
    idFileSystemLocal.prototype.OpenFileReadFlags = function (relativePath, /*int */ searchFlags, foundInPak, allowCopyFiles, gamedir) {
        if (typeof foundInPak === "undefined") { foundInPak = null; }
        if (typeof allowCopyFiles === "undefined") { allowCopyFiles = true; }
        if (typeof gamedir === "undefined") { gamedir = null; }
    ...
    idFileSystemLocal.prototype.StringToArrayBuffer = function (src) {
    ...
    ===========
    */
    idFileSystemLocal.prototype.OpenFileRead = function (relativePath, allowCopyFiles, gamedir) {
        if (typeof allowCopyFiles === "undefined") { allowCopyFiles = true; }
        if (typeof gamedir === "undefined") { gamedir = null; }
