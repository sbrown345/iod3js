...
=================
*/
idSessionLocal.prototype.SetGUI = function ( gui: idUserInterface, handle: ( str: string ) => string /*HandleGuiCommand_t*/ ): void {
	var cmd: string;
	...
	if ( this.guiActive == this.guiMainMenu ) {
		this.SetSaveGameGuiVars ( );
		this.SetMainMenuGuiVars ( );
	...
	this.guiActive.Activate( true, this.com_frameTime );
};
...
////		name += date;
////
////		this.guiActive.SetStateString( va("loadgame_item_%i", i), name);
////	}
////	this.guiActive.DeleteStateVar( va("loadgame_item_%i", fileList.Num()) );
////
...
////		this.guiActive.SetStateString( va("modsList_item_%i", i), list.GetDescription( i ) );
////		modsList[i] = list.GetMod( i );
////	}
////	this.guiActive.DeleteStateVar( va("modsList_item_%i", list.GetNumMods()) );
...
////		this.guiMainMenu.SetStateInt( va( "skin%i", i+1 ), 0 );
////	}
////	this.guiMainMenu.SetStateInt( va( "skin%i", skinId ), 1 );
////}
////
/////*
////===============
...
////		int choice = this.guiActive.State().GetInt("loadgame_sel_0");
...
////		const char *saveGameName = this.guiActive.State().GetString("saveGameName");
...
////			SetSaveGameGuiVars( );
////			this.guiActive.StateChanged( this.com_frameTime );
////		}
////		return true;
////	}
////
...
////			this.guiActive.SetStateString( "saveGameName", saveName );
////			this.guiActive.SetStateString( "saveGameDescription", description );
////
////			ID_TIME_T timeStamp;
...
////			this.guiActive.SetStateString( "saveGameDate", date.Left( tab ) );
////			this.guiActive.SetStateString( "saveGameTime", time );
////		}
////		return true;
////	}
////
...
////	this.guiMainMenu.SetStateString( "current_levelshot", screenshot );
////}
////
/////*
////==============
...
////			int choice = this.guiActive.State().GetInt( "modsList_sel_0" );
...
////			int sel = this.guiActive.State().GetInt( "serverList_selid_0" ); 
...
////			const char	*s = this.guiMainMenu.State().GetString( "inetGame" );
////
////			if ( !s || s[0] == 0 ) {
...
////			int dedicated = this.guiActive.State().GetInt( "dedicated" );
...
////			idStr temp = this.guiActive.State().GetString( "chattext" );
////			temp += "\r";
...
////			const char	*cmd;
////			cmd = this.guiActive.HandleEvent( &ev, this.com_frameTime );
////			this.guiActive.Activate( false, this.com_frameTime );
////			this.guiActive = NULL;
////		}
////	}
////}
...
////	} else if ( game && this.guiActive && this.guiActive.State().GetBool( "gameDraw" ) ) {
...
////	}
////
////	menuCommand = this.guiActive.HandleEvent( event, this.com_frameTime );
////
...
////	if ( console.Active() || this.guiActive ) {
...
////
////	ev.evType = SE_NONE;
////	cmd = gui.HandleEvent( &ev, this.com_frameTime );
////	if ( cmd && cmd[0] ) {
////		DispatchCommand( this.guiActive, cmd );
////	}
////}
////
/////*
...
////		msgRunning = false;
////		msgRetIndex = 0;
////		DispatchCommand( this.guiActive, msgFireBack[ 0 ].c_str() );
////	} else if ( idStr.Icmp( menuCommand, "right" ) == 0 ) {
////		this.guiActive = guiMsgRestore;
////		guiMsgRestore = NULL;
////		msgRunning = false;
////		msgRetIndex = 1;
////		DispatchCommand( this.guiActive, msgFireBack[ 1 ].c_str() );
////	}
////}
////
/////*
...
////		return;
////	}
////	this.guiMainMenu.SetStateString( "str_d3key_state", common.GetLanguageDict().GetString( va( "#str_071%d", 86 + cdkey_state ) ) );
////	this.guiMainMenu.SetStateString( "str_xpkey_state", common.GetLanguageDict().GetString( va( "#str_071%d", 86 + xpkey_state ) ) );
////}
