...
function DEUBG_VertexCache ( args: idCmdArgs ): void {
	vertexCache.List ( );
}
...
*/
	List ( ): void {
		var /*int*/ numActive = 0;
		var /*int*/ numDeferred = 0;
		var /*int*/ frameStatic = 0;
		var /*int*/ totalStatic = 0;
		var /*int*/ deferredSpace = 0;
