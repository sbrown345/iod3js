...
===================
*/
function R_FreeEntityDefDerivedData ( def: idRenderEntityLocal, keepDecals: boolean, keepCachedDynamicModel: boolean ): void {
	var /*int */i: number;
	var ref: areaReference_t, next: areaReference_t;
...
===================
*/
function R_CheckForEntityDefsUsingModel ( model: idRenderModel ): void {
