...
////
	static r_megaTextureLevel = new idCVar ( "r_megaTextureLevel", "0", CVAR_RENDERER | CVAR_INTEGER, "draw only a specific level" );
	static r_showMegaTexture = new idCVar ( "r_showMegaTexture", "0", CVAR_RENDERER | CVAR_BOOL, "display all the level images" );
	static r_showMegaTextureLabels = new idCVar ( "r_showMegaTextureLabels", "0", CVAR_RENDERER | CVAR_BOOL, "draw colored blocks in each tile" );
	static r_skipMegaTexture = new idCVar ( "r_skipMegaTexture", "0", CVAR_RENDERER | CVAR_INTEGER, "only use the lowest level image" );
	static r_terrainScale = new idCVar ( "r_terrainScale", "3", CVAR_RENDERER | CVAR_INTEGER, "vertically scale USGS data" );
////
////};
////
////
