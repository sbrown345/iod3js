...
=================
*/
function R_DeformDrawSurf(drawSurf: drawSurf_t): void {
	...
	case deform_t.DFRM_NONE:
		return;
	case deform_t.DFRM_SPRITE:
		todoThrow( "R_AutospriteDeform( drawSurf );" );
		break;
	case deform_t.DFRM_TUBE:
		todoThrow("R_TubeDeform( drawSurf );");
		break;
	case deform_t.DFRM_FLARE:
		todoThrow("R_FlareDeform( drawSurf );");
		break;
	case deform_t.DFRM_EXPAND:
		todoThrow("R_ExpandDeform( drawSurf );");
		break;
	case deform_t.DFRM_MOVE:
		todoThrow("R_MoveDeform( drawSurf );");
		break;
	case deform_t.DFRM_TURB:
		todoThrow("R_TurbulentDeform( drawSurf );");
		break;
	case deform_t.DFRM_EYEBALL:
		todoThrow("R_EyeballDeform( drawSurf );");
		break;
	case deform_t.DFRM_PARTICLE:
		todoThrow("R_ParticleDeform( drawSurf, true );");
		break;
	case deform_t.DFRM_PARTICLE2:
		todoThrow("R_ParticleDeform( drawSurf, false );");
		break;
	}
}
