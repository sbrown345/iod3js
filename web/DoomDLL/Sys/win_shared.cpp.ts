...
var sys_timeBase: number;
var Sys_Milliseconds_initialized: boolean;
function Sys_Milliseconds ( ): number {
	var /*int */sys_curtime: number;
	Sys_Milliseconds_initialized = false;

	if ( !Sys_Milliseconds_initialized ) {
		sys_timeBase = timeGetTime ( );
		Sys_Milliseconds_initialized = true;
	}
