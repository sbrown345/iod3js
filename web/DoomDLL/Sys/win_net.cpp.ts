...
////
var net_ip = new idCVar ( "net_ip", "localhost", CVAR_SYSTEM, "local IP address" );
var net_port = new idCVar ( "net_port", "0", CVAR_SYSTEM | CVAR_INTEGER, "local IP port number" );
var net_forceLatency = new idCVar ( "net_forceLatency", "0", CVAR_SYSTEM | CVAR_INTEGER, "milliseconds latency" );
var net_forceDrop = new idCVar ( "net_forceDrop", "0", CVAR_SYSTEM | CVAR_INTEGER, "percentage packet loss" );

var net_socksEnabled = new idCVar ( "net_socksEnabled", "0", CVAR_SYSTEM | CVAR_ARCHIVE | CVAR_BOOL, "" );
var net_socksServer = new idCVar ( "net_socksServer", "", CVAR_SYSTEM | CVAR_ARCHIVE, "" );
var net_socksPort = new idCVar ( "net_socksPort", "1080", CVAR_SYSTEM | CVAR_ARCHIVE | CVAR_INTEGER, "" );
var net_socksUsername = new idCVar ( "net_socksUsername", "", CVAR_SYSTEM | CVAR_ARCHIVE, "" );
var net_socksPassword = new idCVar ( "net_socksPassword", "", CVAR_SYSTEM | CVAR_ARCHIVE, "" );
////
////
