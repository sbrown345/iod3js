...
===========
*/
function Sys_InitScanTable ( ): void {
	todo ( );
	...
	//	todoThrow("keyScanTable = s_scantokey_spanish;");
	//	rightAltKey = K_RIGHT_ALT;
	//} else if ( lang.Icmp( "french" ) == 0 ) {
	//	todoThrow("keyScanTable = s_scantokey_french;");
	//	rightAltKey = K_RIGHT_ALT;
	//} else if ( lang.Icmp( "german" ) == 0 ) {
	//	todoThrow("keyScanTable = s_scantokey_german;
	//	rightAltKey = K_RIGHT_ALT;
	//} else if ( lang.Icmp( "italian" ) == 0 ) {
	//	todoThrow("keyScanTable = s_scantokey_italian;");
	//	rightAltKey = K_RIGHT_ALT;
	//}
}
//
