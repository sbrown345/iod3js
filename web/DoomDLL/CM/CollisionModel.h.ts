...
// contact info
class contactInfo_t {
	type:contactType_t;			// contact type									 ////	contactType_t			
	point = new idVec3;			// point of contact								 ////	idVec3					
	normal = new idVec3;			// contact plane normal						 ////	idVec3					
	dist:number;			// contact plane distance							 ////	float					
	contents:number;		// contents at other side of surface				 ////	int						
	material:idMaterial;		// surface material								 ////	const idMaterial *		
	modelFeature:number;	// contact feature on model							 ////	int						
	trmFeature:number;		// contact feature on trace model					 ////	int						
	entityNum:number;		// entity the contact surface is a part of			 ////	int						
...
// trace result
class trace_t {
	fraction:number;		// fraction of movement completed, 1.0 = didn't hit anything   //float					
	endpos = new idVec3;			// final position of trace model							   //idVec3					
